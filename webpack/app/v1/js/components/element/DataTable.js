    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="col-xs-12">*/}
                { o.data.page.length ? <RDC.Table className="table table-striped table-hover" columns={columns} keys={o.config.keys} dataArray={o.data.page} sortBy={o.config.sortBy} onSort={this.props.handleSort} /> : <div /> }
                {/*</div>
